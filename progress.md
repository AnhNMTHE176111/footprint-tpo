...
## 📍 Đang ở đâu
- **Bài hiện tại:** 🟢 **EBOOK Order Flow — Volume Profile** (đã xong **P1**). 5/5 bài khóa chính HOÀN TẤT.
- **Buổi tới:** **Volume Profile P2** — 4 hình dạng **D / P / b / mỏng** + 3 setup VP (tích lũy / xu hướng / từ chối). Sau VP → Imbalance / Stacked Imbalance → 5 setup giao dịch + 4 setup xác nhận. Mục tiêu: đủ vốn để cuối tuần tiếp thu system của bạn trader.
- **Lần học gần nhất:** 2026-06-22 — **drill Bulge vs Flip PASS** (tự bật ra "Flip") + học **Volume Profile P1**: đọc profile; **POC / Value Area / HVN / LVN**; VP = **bản đồ S/R**. Kiểm tra 3 câu đạt.
