...
## 📍 Đang ở đâu
- **Bài hiện tại:** 🟢 **EBOOK Order Flow** — Volume Profile HOÀN TẤT (đọc P1+P2 ✅ · **3 setup VP** tích lũy/xu hướng/từ chối ✅ 2026-06-24). 5/5 bài khóa chính xong.
- **Buổi tới:** **Imbalance / Stacked Imbalance** → **5 setup giao dịch** (Volume Cluster · Multiple Nodes · Trade Filter · Stacked Imbalance · Unfinished Business) + **4 setup xác nhận** (Large Limit Orders · Absorption · Flow+Delta · Cumulative Delta Divergence) → quản lý lệnh (chốt lời/dừng lỗ).
- **Lần học gần nhất:** 2026-06-24 — **3 setup Volume Profile** (tích lũy/xu hướng/từ chối). Cùng 1 quy trình: tìm **Volume Cluster** (mức KL nặng nhất) → vùng **S/R** → chờ giá QUAY LẠI → mở Order Flow chờ **xác nhận** → vào lệnh (cụm ở **đáy = MUA**, **đỉnh = BÁN**). KT 3+3 câu đều đạt; lỗi nhỏ đã sửa: cụm **Setup #3 nằm ở ĐÁY nhọn chữ V** (chỗ giá bị từ chối), không phải phần cao của V.
