...
## 📍 Đang ở đâu
- **Bài hiện tại:** 🟢 **EBOOK Order Flow** — Volume Profile (phần ĐỌC) ✅ xong **P1 + P2**; còn 3 setup VP (gộp cụm setup). 5/5 bài khóa chính HOÀN TẤT.
- **Buổi tới:** **3 setup giao dịch bằng Volume Profile** (tích lũy / xu hướng / từ chối — ứng dụng trực tiếp 4 hình dạng) → **Imbalance / Stacked Imbalance** → 5 setup + 4 setup xác nhận → quản lý lệnh.
- **Lần học gần nhất:** 2026-06-22 (buổi đầy đặn) — **drill Bulge↔Flip PASS** + **Volume Profile P1** (đọc profile; POC/Value Area/HVN/LVN; VP = bản đồ S/R) + **P2** (4 hình dạng **D/P/b/mỏng**). Hai lần kiểm tra (3+3 câu) đều đạt.
