...
## 📍 Đang ở đâu
- **Bài hiện tại:** ✅ **Bài 5 XONG** (khung 3 trạng thái + tổng ôn + 4 exercise đọc chart: #1,#2,#3,#5). 5/5 bài khóa chính HOÀN TẤT.
- **Buổi tới:** (tùy chọn) làm nốt Exercise #4/#6 cho chắc mắt, **RỒI sang EBOOK** Order Flow (Volume Profile POC/Value Area → Imbalance/Stacked Imbalance → 5 setup giao dịch + 4 setup xác nhận). Mục tiêu: đủ vốn để cuối tuần tiếp thu system của bạn trader.
  - 🔴 **DRILL ĐẦU BUỔI SAU — Bulge vs Flip (lỗi lặp 2 lần hôm 21/6):** người học cứ gọi nhầm cú "delta lật dấu qua 2-3 nến, giá đổi hướng theo" là **Bulge**. ĐÚNG = **Delta Flip** (họ "số nến"). **Bulge** = soi MỘT Ô ngược khổng lồ bị hấp thụ trong 1 nến, giá KHÔNG đi theo ô đó (họ "ô lạc loài"). Mnemonic chốt: **Bulge soi 1 Ô · Flip soi cả NẾN (delta tổng đổi dấu)**. Hỏi xoẹt lại tới khi tự bật ra "Flip".
- **Lần học gần nhất:** 2026-06-21 — **luyện 2 exercise đọc chart (#1, #2), đọc số thật trên panel**.
  - **Ex#1** (uptrend): đọc xuất sắc — tự verify nến Sell Reversal đỉnh Max+283/Min−291/đóng−284; chọn vùng B (delta surge xác nhận) làm lệnh xương sống, từ chối short ngược trend nếu chưa có CHoCH → tư duy R:R/market-structure rất chín. Lỗi nhỏ: gọi vùng đi ngang là "đuối/đảo" (đúng ra = giằng co/tích lũy; 3 trạng thái chỉ mô tả một CÚ DI CHUYỂN).
  - **Ex#2** (V-bottom): nhận đúng **absorption** ở đáy (volume 12k–15k mà delta≈0). Nhưng **gọi nhầm cú delta lật +832/+989… là "Bulge"** (đúng = **Delta Flip**, nến trước −2606 đóng ở Min → nến sau +832 đóng sát Max). Quên tên **selling climax / Delta Surge bán** cho nến −4812 (Max 0 = bán thuần). Q4 (V-bottom = climax + absorption + Flip stack lại nên đáng tin hơn bắt đáy thường) chưa trả lời được — đã giảng.
